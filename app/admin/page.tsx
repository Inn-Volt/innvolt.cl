...
export default function AdminPanel() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      showFeedback(editId ? 'Proyecto actualizado OK' : 'Proyecto publicado OK', true);
      ...
      <div className="admin-wrap">
        ...
        <main className="admin-main">
          ...
          <div className="admin-tabs">
            ...
            {tab === 'editar' && (
              <span className="admin-tab tab-active">pencil Editando</span>
            )}
          </div>
                        ...
                        <div key={idx} className="upload-thumb">
                          ...
                          {u.status === 'error' && (
                            <div className="thumb-overlay" style={{ background: 'rgba(239,68,68,0.7)' }}>
                              <span style={{ fontSize: '1.4rem' }}>X</span>
                            </div>
                          )}
                          {u.status === 'done' && (
                            <div className="thumb-badge thumb-ok">OK</div>
                          )}
                          <button className="thumb-remove" onClick={() => removeUpload(idx)}>X</button>
                    ...
                    <div key={p.id} className={`proj-card ${!p.activo ? 'proj-hidden' : ''}`}>
                      ...
                      <div className="proj-info">
                        ...
                        <div className="proj-actions">
                          <button onClick={() => startEdit(p)} className="proj-btn">pencil Editar</button>
